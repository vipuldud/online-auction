            ...
            <section className="contact contacttextt">
              <div className="content" data-aos="flip-left" data-aos-delay="100">
                ...
                <div className="section-title">
                  ...
                  <p data-aos="fade-up" data-aos-delay="400"> Feel free to contact with estbid. If you have any query then please submit your quetions with your details. Keep bidding!!!</p>
                </div>
              </div>
                ...
                <div className="contactInfo col-xl-6">
                  ...
                  <div className="box" data-aos="fade-up-right" data-aos-delay="400">
                    <div className="step">
                      ...
                      <div className="text">
                        <h3>Address</h3>
                        <p>101 , Head post office gali, raghunath ganj
                        </p>
                      </div>
                    </div>
                    {/* <h1>xwxw</h1> */}
