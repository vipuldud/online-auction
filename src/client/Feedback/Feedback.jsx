				...
				<div className="col-md-12">
					<div className="wrapper">
						<div className="row mb-5" data-aos="fade-up" data-aos-delay="300">
			        		...
			        		<div className="text">
				            <p><span>Email:</span> <a href="mailto:srajansethiya123@gmail.com">Bestbid@gmail.com</a></p>
				          </div>
			          </div>
							</div>
							<div className="col-md-3">
			        		...
			        		<div className="text">
				            <p><span>Website</span> <a href="#">Bestbid.com</a></p>
				          </div>
			          </div>
							</div>
						</div>
